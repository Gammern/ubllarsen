...
namespace UblLarsen.Test
{
    ...
    public class IntegrationTests
    {
        ...
        public void MyTransportationStatusTest()
        {
            ...
            Assert.Inconclusive("Signatures/extensions not implemented!");
        }
        ...
        public void UBLCreditNote20ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written CreditNoteType differs from the one read");
        }
        ...
        public void UBLDebitNote21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written DebitNoteType differs from the one read");
        }
        ...
        public void UBLDespatchAdvice20ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written DespatchAdviceType differs from the one read");
        }
        ...
        public void UBLExceptionCriteria21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written ExceptionCriteriaType differs from the one read");
        }
        ...
        public void UBLExceptionNotification21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written ExceptionNotificationType differs from the one read");
        }
        ...
        public void UBLForecast21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written ForecastType differs from the one read");
        }
        ...
        public void UBLForecastRevision21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written ForecastRevisionType differs from the one read");
        }
        ...
        public void UBLForwardingInstructions20ExampleInternationalTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written ForwardingInstructionsType differs from the one read");
        }
        ...
        public void UBLFreightInvoice21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written FreightInvoiceType differs from the one read");
        }
        ...
        public void UBLFulfilmentCancellation21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written FulfilmentCancellationType differs from the one read");
        }
        ...
        public void UBLGoodsItemItinerary21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written GoodsItemItineraryType differs from the one read");
        }
        ...
        public void UBLInstructionForReturns21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written InstructionForReturnsType differs from the one read");
        }
        ...
        public void UBLInventoryReport21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written InventoryReportType differs from the one read");
        }
        ...
        public void UBLInvoice20ExampleNS1Test()
        {
            ...
            Assert.IsTrue(areEqual, "Written InvoiceType differs from the one read");
        }
        ...
        public void UBLOrder20ExampleInternationalTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written OrderType differs from the one read");
        }
        ...
        public void UBLOrderCancellation21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written OrderCancellationType differs from the one read");
        }
        ...
        public void UBLOrderChange21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written OrderChangeType differs from the one read");
        }
        ...
        public void UBLOrderResponse21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written OrderResponseType differs from the one read");
        }
        ...
        public void UBLOrderResponseSimple20ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written OrderResponseSimpleType differs from the one read");
        }
        ...
        public void UBLProductActivity21Example1Test()
        {
            ...
            Assert.IsTrue(areEqual, "Written ProductActivityType differs from the one read");
        }
        ...
        public void UBLQuotation20ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written QuotationType differs from the one read");
        }
        ...
        public void UBLReceiptAdvice20ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written ReceiptAdviceType differs from the one read");
        }
        ...
        public void UBLReminder21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written ReminderType differs from the one read");
        }
        ...
        public void UBLRemittanceAdvice20ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written RemittanceAdviceType differs from the one read");
        }
        ...
        public void UBLRequestForQuotation20ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written RequestForQuotationType differs from the one read");
        }
        ...
        public void UBLRetailEvent21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written RetailEventType differs from the one read");
        }
        ...
        public void UBLSelfBilledCreditNote21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written SelfBilledCreditNoteType differs from the one read");
        }
        ...
        public void UBLStatement20ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written StatementType differs from the one read");
        }
        ...
        public void UBLStockAvailabilityReport21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written StockAvailabilityReportType differs from the one read");
        }
        ...
        public void UBLTradeItemLocationProfile21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written TradeItemLocationProfileType differs from the one read");
        }
        ...
        public void UBLTransportationStatus21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written TransportationStatusType differs from the one read");
        }
        ...
        public void UBLTransportationStatusRequest21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written TransportationStatusRequestType differs from the one read");
        }
        ...
        public void UBLTransportExecutionPlan21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written TransportExecutionPlanType differs from the one read");
        }
        ...
        public void UBLTransportExecutionPlanRequest21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written TransportExecutionPlanRequestType differs from the one read");
        }
        ...
        public void UBLTransportProgressStatus21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written TransportProgressStatusType differs from the one read");
        }
        ...
        public void UBLTransportProgressStatusRequest21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written TransportProgressStatusRequestType differs from the one read");
        }
        ...
        public void UBLTransportServiceDescription21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written TransportServiceDescriptionType differs from the one read");
        }
        ...
        public void UBLTransportServiceDescriptionRequest21ExampleTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written TransportServiceDescriptionRequestType differs from the one read");
        }
        ...
        public void UBLWaybill20ExampleInternationalTest()
        {
            ...
            Assert.IsTrue(areEqual, "Written WaybillType differs from the one read");
        }
    }
}
